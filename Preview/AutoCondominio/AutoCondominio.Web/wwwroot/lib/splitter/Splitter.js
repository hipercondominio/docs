///<reference path="../../jquery/js/jquery.js" />

/*!
 * Url: https://github.com/jcubic/jquery.splitter
...
//adicionar background e alguns comportamentos



var $self = $("Splitter:first");
$self.direction = $self.attr("direction");
$self.proportion = $self.attr("proportion");
